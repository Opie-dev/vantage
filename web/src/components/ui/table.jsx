...
function TableHead({
  ...
  return (
    <th
      ...
      className={cn(
        // Vantage: the legacy micro-label header — uppercase, tracked, muted.
        "h-9 px-2.5 text-left align-middle text-[10.5px] font-semibold tracking-[0.09em] whitespace-nowrap text-muted-foreground uppercase [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-[2px]",
        className
      )}
      {...props} />
  );
